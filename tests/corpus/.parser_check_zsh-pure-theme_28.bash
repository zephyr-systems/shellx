...
prompt_pure_update_vim_prompt_widget() {
	setopt localoptions noshwordsplit
	prompt_pure_state[prompt]=${${KEYMAP/vicmd/${PURE_PROMPT_VICMD_SYMBOL:-❮}}/main/${PURE_PROMPT_SYMBOL:-❯}}|	prompt_pure_state[prompt]=${${KEYMAP/vicmd/${PURE_PROMPT_VICMD_SYMBOL:-❮}}/viins/${PURE_PROMPT_SYMBOL:-❯}}
...
:
	...
	__shellx_zle_register_widget prompt_pure_reset_prompt prompt_pure_reset_prompt
	__shellx_zle_register_widget prompt_pure_update_vim_prompt_widget prompt_pure_update_vim_prompt_widget
	__shellx_zle_register_widget prompt_pure_reset_vim_prompt_widget prompt_pure_reset_vim_prompt_widget
