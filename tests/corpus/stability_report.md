...
| fish->zsh | 11 | 11/11 | 11/11 | 8/11 | 0 | 10/10 | 1/1 | 1 | 19 | 1.142 | 4.430 | 11 |
| zsh->bash | 15 | 15/15 | 15/15 | 9/15 | 0 | 10/10 | 5/5 | 76 | 4 | 0.896 | 1.842 | 4 |
| zsh->fish | 15 | 15/15 | 15/15 | 15/15 | 0 | 10/10 | 5/5 | 76 | 58 | 1.791 | 9.812 | 15 |
| zsh->posix | 15 | 15/15 | 15/15 | 7/15 | 0 | 10/10 | 5/5 | 76 | 22 | 1.273 | 5.493 | 14 |

## Failures

- [FAIL] zsh-autosuggestions (plugin) zsh->bash translate=true parse=true parser=false/true exit=2 err=None warnings=5(parse=4 compat=1) shims=1 src_fn=30 out_fn=28 msg= parser_msg=tests/corpus/.parser_check_zsh-autosuggestions_1.bash: line 632: syntax error near unexpected token `fi'
...
- [FAIL] zsh-autosuggestions (plugin) zsh->posix translate=true parse=true parser=false/true exit=2 err=None warnings=7(parse=4 compat=3) shims=3 src_fn=30 out_fn=37 msg= parser_msg=tests/corpus/.parser_check_zsh-autosuggestions_3.sh: line 842: syntax error: unexpected end of file from `{' command on line 417
 path=tests/corpus/repos/zsh/zsh-autosuggestions/zsh-autosuggestions.zsh
- [FAIL] zsh-syntax-highlighting (plugin) zsh->bash translate=true parse=true parser=false/true exit=2 err=None warnings=7(parse=6 compat=1) shims=1 src_fn=9 out_fn=13 msg= parser_msg=tests/corpus/.parser_check_zsh-syntax-highlighting_4.bash: line 171: syntax error near unexpected token `}'
...
- [FAIL] zsh-syntax-highlighting (plugin) zsh->posix translate=true parse=true parser=false/true exit=2 err=None warnings=9(parse=6 compat=3) shims=3 src_fn=9 out_fn=20 msg= parser_msg=tests/corpus/.parser_check_zsh-syntax-highlighting_6.sh: line 164: syntax error near unexpected token `}'
tests/corpus/.parser_check_zsh-syntax-highlighting_6.sh: line 164: `}'
 path=tests/corpus/repos/zsh/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
- [FAIL] ohmyzsh-git (plugin) zsh->posix translate=true parse=true parser=false/true exit=2 err=None warnings=5(parse=4 compat=1) shims=1 src_fn=16 out_fn=20 msg= parser_msg=tests/corpus/.parser_check_ohmyzsh-git_9.sh: line 459: syntax error: unexpected end of file from `{' command on line 161
 path=tests/corpus/repos/zsh/ohmyzsh/plugins/git/git.plugin.zsh
- [FAIL] ohmyzsh-z (plugin) zsh->bash translate=true parse=true parser=false/true exit=2 err=None warnings=15(parse=14 compat=1) shims=1 src_fn=14 out_fn=10 msg= parser_msg=tests/corpus/.parser_check_ohmyzsh-z_10.bash: line 172: syntax error near unexpected token `('
...
- [FAIL] ohmyzsh-z (plugin) zsh->posix translate=true parse=true parser=false/true exit=2 err=None warnings=17(parse=14 compat=3) shims=3 src_fn=14 out_fn=21 msg= parser_msg=tests/corpus/.parser_check_ohmyzsh-z_12.sh: line 142: syntax error near unexpected token `('
...
tests/corpus/.parser_check_ohmyzsh-sudo_18.sh: line 131: `	      || builtin which -a "$realcmd" | command grep -Fx -q "$editorcmd"; then'
 path=tests/corpus/repos/zsh/ohmyzsh/plugins/sudo/sudo.plugin.zsh
- [FAIL] ohmyzsh-extract (plugin) zsh->bash translate=true parse=true parser=false/true exit=2 err=None warnings=1(parse=1 compat=0) shims=0 src_fn=0 out_fn=1 msg= parser_msg=tests/corpus/.parser_check_ohmyzsh-extract_19.bash: line 77: syntax error near unexpected token `;;' while looking for matching `)'
tests/corpus/.parser_check_ohmyzsh-extract_19.bash: line 77: `      (*.gz) (( $+commands[pigz] )) && pigz -cdk "$full_path" > "$(__shellx_zsh_expand "\${file:t:r})" || gunzip -ck "$full_path" > "$(__shellx_zsh_expand "\${file:t:r})" ;;'
 path=tests/corpus/repos/zsh/ohmyzsh/plugins/extract/extract.plugin.zsh
- [FAIL] ohmyzsh-extract (plugin) zsh->posix translate=true parse=true parser=false/true exit=2 err=None warnings=2(parse=1 compat=1) shims=1 src_fn=0 out_fn=10 msg= parser_msg=tests/corpus/.parser_check_ohmyzsh-extract_21.sh: line 137: syntax error near unexpected token `;;' while looking for matching `)'
tests/corpus/.parser_check_ohmyzsh-extract_21.sh: line 137: `      (*.gz) (( $+commands[pigz] )) && pigz -cdk "$full_path" > "$(__shellx_zsh_expand "\${file:t:r})" || gunzip -ck "$full_path" > "$(__shellx_zsh_expand "\${file:t:r})" ;;'
 path=tests/corpus/repos/zsh/ohmyzsh/plugins/extract/extract.plugin.zsh
...
tests/corpus/.parser_check_fish-autopair_81.sh: line 79: `autopair_right="")" "]" "} '"' "'""'
 path=tests/corpus/repos/fish/autopair.fish/conf.d/autopair.fish
- [FAIL] zsh-agnoster (theme) zsh->bash translate=true parse=true parser=false/true exit=2 err=None warnings=1(parse=1 compat=0) shims=0 src_fn=14 out_fn=14 msg= parser_msg=tests/corpus/.parser_check_zsh-agnoster_94.bash: line 356: syntax error near unexpected token `newline'
tests/corpus/.parser_check_zsh-agnoster_94.bash: line 356: `:'
 path=tests/corpus/repos/zsh/ohmyzsh/themes/agnoster.zsh-theme
- [FAIL] zsh-agnoster (theme) zsh->posix translate=true parse=true parser=false/true exit=2 err=None warnings=2(parse=1 compat=1) shims=1 src_fn=14 out_fn=24 msg= parser_msg=tests/corpus/.parser_check_zsh-agnoster_96.sh: line 219: syntax error near unexpected token `newline'
...
tests/corpus/.parser_check_zsh-autosuggestions_1.bash: line 632: `	fi'
 path=tests/corpus/repos/zsh/zsh-autosuggestions/zsh-autosuggestions.zsh
- [PARSER-FAIL] zsh-autosuggestions (plugin) zsh->posix command=`bash -n tests/corpus/.parser_check_zsh-autosuggestions_3.sh` exit=2 message=tests/corpus/.parser_check_zsh-autosuggestions_3.sh: line 842: syntax error: unexpected end of file from `{' command on line 417
 path=tests/corpus/repos/zsh/zsh-autosuggestions/zsh-autosuggestions.zsh
...
tests/corpus/.parser_check_zsh-syntax-highlighting_6.sh: line 164: `}'
 path=tests/corpus/repos/zsh/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
- [PARSER-FAIL] ohmyzsh-git (plugin) zsh->posix command=`bash -n tests/corpus/.parser_check_ohmyzsh-git_9.sh` exit=2 message=tests/corpus/.parser_check_ohmyzsh-git_9.sh: line 459: syntax error: unexpected end of file from `{' command on line 161
 path=tests/corpus/repos/zsh/ohmyzsh/plugins/git/git.plugin.zsh
...
tests/corpus/.parser_check_ohmyzsh-sudo_18.sh: line 131: `	      || builtin which -a "$realcmd" | command grep -Fx -q "$editorcmd"; then'
 path=tests/corpus/repos/zsh/ohmyzsh/plugins/sudo/sudo.plugin.zsh
- [PARSER-FAIL] ohmyzsh-extract (plugin) zsh->bash command=`bash -n tests/corpus/.parser_check_ohmyzsh-extract_19.bash` exit=2 message=tests/corpus/.parser_check_ohmyzsh-extract_19.bash: line 77: syntax error near unexpected token `;;' while looking for matching `)'
tests/corpus/.parser_check_ohmyzsh-extract_19.bash: line 77: `      (*.gz) (( $+commands[pigz] )) && pigz -cdk "$full_path" > "$(__shellx_zsh_expand "\${file:t:r})" || gunzip -ck "$full_path" > "$(__shellx_zsh_expand "\${file:t:r})" ;;'
 path=tests/corpus/repos/zsh/ohmyzsh/plugins/extract/extract.plugin.zsh
- [PARSER-FAIL] ohmyzsh-extract (plugin) zsh->posix command=`bash -n tests/corpus/.parser_check_ohmyzsh-extract_21.sh` exit=2 message=tests/corpus/.parser_check_ohmyzsh-extract_21.sh: line 137: syntax error near unexpected token `;;' while looking for matching `)'
tests/corpus/.parser_check_ohmyzsh-extract_21.sh: line 137: `      (*.gz) (( $+commands[pigz] )) && pigz -cdk "$full_path" > "$(__shellx_zsh_expand "\${file:t:r})" || gunzip -ck "$full_path" > "$(__shellx_zsh_expand "\${file:t:r})" ;;'
 path=tests/corpus/repos/zsh/ohmyzsh/plugins/extract/extract.plugin.zsh
