...
- [FAIL] zsh-autosuggestions (plugin) zsh->fish translate=true parse=true parser=false/true exit=127 err=None warnings=10(parse=4 compat=6) shims=6 src_fn=30 out_fn=30 msg= parser_msg=tests/corpus/.parser_check_zsh-autosuggestions_2.fish (line 515): Expected end of the statement, but found an incomplete token
...
- [FAIL] zsh-syntax-highlighting (plugin) zsh->fish translate=true parse=true parser=false/true exit=127 err=None warnings=12(parse=6 compat=6) shims=6 src_fn=9 out_fn=31 msg= parser_msg=tests/corpus/.parser_check_zsh-syntax-highlighting_5.fish (line 394): Missing end to balance this switch statement
...
- [FAIL] zsh-powerlevel10k (theme) zsh->fish translate=true parse=true parser=false/true exit=127 err=None warnings=8(parse=4 compat=4) shims=4 src_fn=1 out_fn=18 msg= parser_msg=tests/corpus/.parser_check_zsh-powerlevel10k_92.fish (line 188): Expected end of the statement, but found an incomplete token
...
- [FAIL] zsh-agnoster (theme) zsh->fish translate=true parse=true parser=false/true exit=127 err=None warnings=4(parse=1 compat=3) shims=3 src_fn=14 out_fn=22 msg= parser_msg=tests/corpus/.parser_check_zsh-agnoster_95.fish (line 198): Unsupported use of '='. In fish, please use 'set bzr_status (command bzr status 2>&1)'.
...
tests/corpus/.parser_check_zsh-agnoster_96.sh: line 381: `fi'
 path=tests/corpus/repos/zsh/ohmyzsh/themes/agnoster.zsh-theme
- [FAIL] zsh-spaceship (theme) zsh->fish translate=true parse=true parser=false/true exit=127 err=None warnings=18(parse=14 compat=4) shims=4 src_fn=1 out_fn=23 msg= parser_msg=tests/corpus/.parser_check_zsh-spaceship_101.fish (line 231): Expected a command, but found end of the statement
...
tests/corpus/.parser_check_zsh-autosuggestions_1.bash: line 565: `	done'
 path=tests/corpus/repos/zsh/zsh-autosuggestions/zsh-autosuggestions.zsh
- [PARSER-FAIL] zsh-autosuggestions (plugin) zsh->fish command=`fish --no-execute tests/corpus/.parser_check_zsh-autosuggestions_2.fish` exit=127 message=tests/corpus/.parser_check_zsh-autosuggestions_2.fish (line 515): Expected end of the statement, but found an incomplete token
# THE SOFTWARE IS PROVIDED "AS IS", WITHOUT WARRANTY OF ANY KIND,
                                 ^
warning: Error while reading file tests/corpus/.parser_check_zsh-autosuggestions_2.fish
 path=tests/corpus/repos/zsh/zsh-autosuggestions/zsh-autosuggestions.zsh
...
tests/corpus/.parser_check_zsh-syntax-highlighting_4.bash: line 171: `}'
 path=tests/corpus/repos/zsh/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
- [PARSER-FAIL] zsh-syntax-highlighting (plugin) zsh->fish command=`fish --no-execute tests/corpus/.parser_check_zsh-syntax-highlighting_5.fish` exit=127 message=tests/corpus/.parser_check_zsh-syntax-highlighting_5.fish (line 394): Missing end to balance this switch statement
    switch $region_highlight
    ^~~~~^
warning: Error while reading file tests/corpus/.parser_check_zsh-syntax-highlighting_5.fish
 path=tests/corpus/repos/zsh/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
...
tests/corpus/.parser_check_fish-autopair_81.sh: line 80: `autopair_pairs=""()" "[]" "{}" '""' "''""'
 path=tests/corpus/repos/fish/autopair.fish/conf.d/autopair.fish
- [PARSER-FAIL] zsh-powerlevel10k (theme) zsh->fish command=`fish --no-execute tests/corpus/.parser_check_zsh-powerlevel10k_92.fish` exit=127 message=tests/corpus/.parser_check_zsh-powerlevel10k_92.fish (line 188): Expected end of the statement, but found an incomplete token
      for f in $__p9k_root_dir/{powerlevel9k.zsh-theme,powerlevel10k.zsh-theme,internal/p10k.zsh,internal/icons.zsh,internal/configure.zsh,internal/worker.zsh,internal/parser.zsh,gitstatus/gitstatus.plugin.zsh,gitstatus/install
                               ^
warning: Erro path=tests/corpus/repos/zsh/powerlevel10k/powerlevel10k.zsh-theme
...
tests/corpus/.parser_check_zsh-agnoster_94.bash: line 384: `fi'
 path=tests/corpus/repos/zsh/ohmyzsh/themes/agnoster.zsh-theme
- [PARSER-FAIL] zsh-agnoster (theme) zsh->fish command=`fish --no-execute tests/corpus/.parser_check_zsh-agnoster_95.fish` exit=127 message=tests/corpus/.parser_check_zsh-agnoster_95.fish (line 198): Unsupported use of '='. In fish, please use 'set bzr_status (command bzr status 2>&1)'.
	  if bzr_status=(command bzr status 2>&1)
	     ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^
warning: Error while reading file tests/corpus/.parser_check_zsh-agnoster_95.fish
 path=tests/corpus/repos/zsh/ohmyzsh/themes/agnoster.zsh-theme
...
tests/corpus/.parser_check_zsh-agnoster_96.sh: line 381: `fi'
 path=tests/corpus/repos/zsh/ohmyzsh/themes/agnoster.zsh-theme
- [PARSER-FAIL] zsh-spaceship (theme) zsh->fish command=`fish --no-execute tests/corpus/.parser_check_zsh-spaceship_101.fish` exit=127 message=tests/corpus/.parser_check_zsh-spaceship_101.fish (line 231): Expected a command, but found end of the statement
    time           # Time stamps section
                                        ^
warning: Error while reading file tests/corpus/.parser_check_zsh-spaceship_101.fish
 path=tests/corpus/repos/zsh/spaceship-prompt/spaceship.zsh-theme
